...
<html xmlns="http://www.w3.org/1999/xhtml" <?php language_attributes(); ?>>
 ...
 <div id="outerrim">
	...
	<div id="header">
		<h1 id="logo">
			<a href="<?php echo site_url() ?>" title="<?php bp_site_name(); ?>">
				<?php bp_site_name() ?>
			</a>
		</h1>
		<div id="access">
			<div class="menu">
				...
				<li id="nav-community"<?php if ( is_page( BP_ACTIVITY_SLUG ) || (is_page( BP_MEMBERS_SLUG ) || bp_is_user()) || (is_page( BP_GROUPS_SLUG ) || bp_is_group()) || is_page( BP_FORUMS_SLUG ) || is_page( BP_BLOGS_SLUG ) )  : ?> class="page_item current-menu-item"<?php endif; ?>>
					...
					<ul class="children">
						<?php if ( 'activity' != bp_dtheme_page_on_front() && bp_is_active( 'activity' ) ) : ?>
							<li<?php if ( is_page( BP_ACTIVITY_SLUG ) ) : ?> class="selected"<?php endif; ?>>
								<a href="<?php echo site_url() ?>/<?php echo BP_ACTIVITY_SLUG ?>/" title="<?php _e( 'Activity', 'buddypress' ) ?>"><?php _e( 'Activity', 'buddypress' ) ?></a>
							</li>
						<?php endif; ?>
		
						<li<?php if ( is_page( BP_MEMBERS_SLUG ) || bp_is_user() ) : ?> class="selected"<?php endif; ?>>
							<a href="<?php echo site_url() ?>/<?php echo BP_MEMBERS_SLUG ?>/" title="<?php _e( 'Members', 'buddypress' ) ?>"><?php _e( 'Members', 'buddypress' ) ?></a>
						</li>
		
						<?php if ( bp_is_active( 'groups' ) ) : ?>
							<li<?php if ( is_page( BP_GROUPS_SLUG ) || bp_is_group() ) : ?> class="selected"<?php endif; ?>>
							...
							<?php if ( bp_is_active( 'forums' ) && ( function_exists( 'bp_forums_is_installed_correctly' ) && !(int) bp_get_option( 'bp-disable-forum-directory' ) ) && bp_forums_is_installed_correctly() ) : ?>
								<li<?php if ( is_page( BP_FORUMS_SLUG ) ) : ?> class="selected"<?php endif; ?>>
						...
						<?php if ( bp_is_active( 'blogs' ) && is_multisite() ) : ?>
							<li<?php if ( is_page( BP_BLOGS_SLUG ) ) : ?> class="selected"<?php endif; ?>>
