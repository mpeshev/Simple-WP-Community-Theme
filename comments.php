	...
	<?php if( defined('SC_DEFAULT_FORM') ):
		comment_form();  ?>
	...
	<?php else : ?>
		...
		<?php if ( pings_open() && !comments_open() && is_single() ) : ?>
			...
			<p class="comments-closed pings-open">
				<?php printf( __('Comments are closed, but <a href="%1$s" title="Trackback URL for this post">trackbacks</a> and pingbacks are open.', 'buddypress'), get_trackback_url( '0' ) ); ?>
			</p>
