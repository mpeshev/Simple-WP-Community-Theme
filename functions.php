...
?>
  <?php
  if ( is_page( BP_ACTIVITY_SLUG ) || (is_page( BP_MEMBERS_SLUG ) || bp_is_user()) || (is_page( BP_GROUPS_SLUG ) || bp_is_group()) || is_page( BP_FORUMS_SLUG ) || is_page( BP_BLOGS_SLUG ) ) { ?>
